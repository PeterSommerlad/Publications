...
// PS: the return type for the (unsigned long long) suffix operators doesn't make
// sense for factors less than 1, e.g. milli. change the macro to return long double quanities instead.
...
#undef QUANTITY_DEFINE_SCALING_LITERAL
#define QUANTITY_DEFINE_SCALING_LITERAL( sfx, dim, factor ) \
