...
constexpr auto OOPNorth=tailor::degrees<48,8,13>;
constexpr auto OOPWest=tailor::degrees<11,41,34>;
...
constexpr auto sine_table_steps=360;

constexpr auto largesinetab=tables::make_sine_table<sine_table_steps+1 ,double>;
...
static_assert(abs(largesinetab[sine_table_steps/4]-1)<1e-12,"sine 90 degree is 1");
static_assert(abs(largesinetab[sine_table_steps/2])<1e-12,"sine 180 degree is 0");
static_assert(abs(largesinetab[sine_table_steps*3/4]+1)<1e-12,"sine 270 degree is -1");
